# documents/botdoc/newsletter/logic.py
from datetime import datetime


def prepare_bot_newsletter_data(user_data: dict) -> dict:
    """
    Подготавливает данные для генерации Согласия на рассылку для бота.

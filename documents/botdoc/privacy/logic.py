# documents/botdoc/privacy/logic.py
from datetime import datetime


def prepare_bot_privacy_data(user_data: dict) -> dict:
    """
    Подготавливает данные для генерации Политики конфиденциальности для бота.
